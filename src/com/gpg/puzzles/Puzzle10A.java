...
/**
 ...
 ([3] 0 1 2. Reversing this sublist (3 0 1 2 4 into 4 2 1 0 3) produces: 3) ([4] 2 1 0.
 ...
 The correct answer is 52070 with puzzle10.dat

 */
public class Puzzle10A extends Puzzle10Base {
    ...
    protected int SolveMe(ArrayList<String> inputData) {
        ...
        for (String ls : inputData.get(0).split(",\\s*")) {
            int len = Integer.parseInt(ls);
